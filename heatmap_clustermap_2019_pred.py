...
g=sns.clustermap(plot_heat, figsize=(20, 20), row_linkage=row_linkage, col_linkage=col_linkage, vmin=0, vmax=5, xticklabels = False, yticklabels = False)
...
g.savefig("picture/2021-12-pred_3_no_axis.png")
...
g.savefig("picture/2021-12-actual_3_no_axis.png")
